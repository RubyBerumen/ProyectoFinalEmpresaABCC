 ...
 * @author clara
 */
public class ConsultasProyecto extends javax.swing.JPanel {

    /**
     * Creates new form AltasEmpleado
     */
    public ConsultasProyecto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Titulo.setText("Buscar proyecto");
        ...
        add(nomProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, -1, 30));

        jtfNomProyecto.setBorder(null);
        add(jtfNomProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 159, 30));
        add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 160, 159, 20));
        ...
        add(numProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130, -1, 30));

        jtfNumProyecto.setBorder(null);
        add(jtfNumProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 130, 50, 30));
        add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 160, 50, 20));
        ...
        add(ubiProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, -1, 30));

        jtfUbiProyecto.setBorder(null);
        add(jtfUbiProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 190, 159, 30));
        add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, 159, 20));
        ...
        add(numDepProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 190, -1, 30));

        jtfNumDepProyecto.setBorder(null);
        add(jtfNumDepProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 190, 50, 30));
        add(jSeparator12, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 220, 50, 20));
        ...
        add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 260, 120, 30));
        ...
        add(btnBorrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 120, 30));
        ...
        add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 260, 120, 30));
